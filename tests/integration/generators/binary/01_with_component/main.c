...
int main() {
  ...
  sample_packet->sample_packet_with_component.with_component_packet_number_1
    = le32toh(sample_packet->sample_packet_with_component.with_component_packet_number_1);
  sample_packet->sample_packet_with_component.with_component_packet_number_2
    = le64toh(sample_packet->sample_packet_with_component.with_component_packet_number_2);
