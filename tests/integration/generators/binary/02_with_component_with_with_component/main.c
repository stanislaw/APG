...
int main() {
  ...
  with_component_packet_inner_with_component.inner_with_component_packet_number_3
    = le16toh(with_component_packet_inner_with_component.inner_with_component_packet_number_3);
  with_component_packet_inner_with_component.inner_with_component_packet_number_4
    = le16toh(with_component_packet_inner_with_component.inner_with_component_packet_number_4);
